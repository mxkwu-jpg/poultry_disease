"""ResNet18 poultry disease inference — uses only ResNet18_poultry_disease.pth."""
...
MODEL_FILENAME = "ResNet18_poultry_disease.pth"
_LEGACY_FILENAME = "resnet18_poultry_diseases.pth"
...
def load_model(base_dir: Path | None = None) -> tuple[nn.Module, str]:
    ...
    return (
        model,
        f"ResNet18 (pretrained=False) loaded from {path.name} on {device}.",
    )
